...
export const createExamDocument = async (exam: ExamDocument): Promise<Blob> => {
    const sections = [
          ...
          new Paragraph({
                  ...
                  children: [
                            new TextRun({ text: "ALAN INTERNATIONAL SCHOOL", bold: true, size: 28 }),
                          ],
          }),
          new Paragraph({
                  alignment: AlignmentType.CENTER,
                  spacing: { after: 400 },
                  children: [
                            new TextRun({ text: exam.subject + " Examination", bold: true, size: 24 }),
                          ],
          }),
          ...
          new Paragraph({
                  children: [
                            new TextRun({ text: "Instructions:", bold: true, size: 22 }),
                          ],
          }),
          new Paragraph({
          ...
          new Paragraph({
                  alignment: AlignmentType.CENTER,
                  children: [
                            new TextRun({ text: "---", italics: true, break: 1 }),
                            new TextRun({ text: "End of Examination", italics: true, break: 1 }),
                            new TextRun({ text: "---", italics: true, break: 1 }),
                          ],
          }),
        ];
